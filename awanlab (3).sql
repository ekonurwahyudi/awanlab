...
CREATE TABLE `orderkalibrasis` (
  ...
  `order_namaalat` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_model` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_merek` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_sn` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_jumlah` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_lokasilab` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_jeniskal` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_namaser` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_alamatser` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `orderkalibrasis` (`order_id`, `order_ccl`, `order_namaalat`, `order_model`, `order_merek`, `order_sn`, `order_jumlah`, `order_lokasilab`, `order_jeniskal`, `order_namaser`, `order_alamatser`, `order_filesph`, `order_statussph`, `order_filepo`, `order_status`, `order_teknisi`, `order_tglantar`, `created_at`, `updated_at`) VALUES
(1, 'CCL/21/0121', 'Insulation Continuity Tester', '3005A', 'Kyoritsu', 'E8219814', '1', 'jakarta', 'inhouse', 'Mr. Rusdi Soleh', 'Ciakrang Barat - Bekasi', NULL, NULL, NULL, 'Proses Kalibrasi', NULL, '15/01/2021', '2021-01-18 02:16:40', '2021-01-18 02:16:40'),
(2, 'CCL/21/0125', 'Audio Analyser', 'APX 515', 'Audio Precisios', 'EP2P-EC-001', '1', 'medan', 'inhouse', 'Mr. Arief', 'Medan Barat 21212', NULL, NULL, NULL, 'Cetak Sertifikat', NULL, '14/01/2021', '2021-01-18 02:17:45', '2021-01-18 02:17:45');
...
(1, 'admin', '', '', 'admin@awanlab.com', NULL, '$2y$10$8yUTTf8cFJXp0e862FH14.zjN4jnUqHzurzqiKpT55qOd1fnh3Pba', '', 'Lab Jakarta', NULL, '2020-12-01 07:09:19', '2020-12-01 07:09:19'),
(4, 'Eko Nurwayudi', '', '', 'eko@awanlab.com', '2021-01-07 21:10:53', '$2y$10$w.l62VPZX3rOLVVchxt.xet3jmxW6RQ00ZjDZWTz0O.yrfbzQP8wG', '', 'Lab Jakarta', NULL, '2020-12-01 07:42:05', '2020-12-01 07:42:05'),
...
(16, 'Rani Wulandari', ' ', NULL, 'rani.wd27@gmail.com', NULL, '$2y$10$H2ppKvb.WbYsqlIhSVIWweLAOL/miK6tt/C5.fuK0PXtKsHhxTf8K', NULL, 'Lab Jakarta', NULL, '2021-01-18 06:27:34', '2021-01-18 06:27:34'),
(17, 'Eddy Haryanto', ' ', NULL, 'eddy@gmail.com', NULL, '$2y$10$HqU4nu/tc6e8QDS3d4XTmOR0r2N.0c5sndJ9fRNFFlyVeO0eaPdge', NULL, 'Lab Jakarta', NULL, '2021-01-18 06:33:48', '2021-01-18 06:33:48'),
(18, 'Dwi Yolan M', ' ', NULL, 'dwiyolanmiswantara@gmail.com', NULL, '$2y$10$h7a4QNoeuHmBoIKd8QPX5eCE3ghrZre1Kqm8ufeTB3M7TF5L1vDaC', NULL, 'Lab Jakarta', NULL, '2021-01-18 06:40:35', '2021-01-18 06:40:35'),
(19, 'Rima Windi Lestari', ' ', NULL, 'rima@gmail.com', NULL, '$2y$10$Bgz7t5nMTUP.HKt.SpMFa.3SJO81NAa4GNraMWLI33wY5Ai5wsx2.', NULL, 'Lab Jakarta', NULL, '2021-01-18 06:49:07', '2021-01-18 06:49:07');
