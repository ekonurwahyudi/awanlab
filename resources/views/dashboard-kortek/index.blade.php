											...
											<div class="card-body p-0">
												...
												<ul class="dashboard-tabs nav nav-pills nav-danger row row-paddingless m-0 p-0 flex-column flex-sm-row" role="tablist">
													...
													<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
														<a class="nav-link active border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" href="/dashboard-kortek">
													...
													@if(Auth::user()->lokasi_kerja == $order->order_lokasilab)
													  @if($order->order_status == "Alat ke korlab")
														<tr>
															...
															<td>
																<form action="/pilihteknisi/{{$order->order_id}}" method="post">
																@csrf
																	<div class="row">
																		<div class="col-8">
																			<select name="teknisi" class="form-control">
																				...
																				@if(Auth::user()->lokasi_kerja == $user->lokasi_kerja)
