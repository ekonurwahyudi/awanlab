											...
											<div class="card-body p-0">
												...
												<ul class="dashboard-tabs nav nav-pills nav-danger row row-paddingless m-0 p-0 flex-column flex-sm-row" role="tablist">
													...
													<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
														<a class="nav-link active border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" href="/dashboard-admin">
													...
													<!--begin::Item-->
													<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
														<a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" href="/monitoring-order">
															<span class="nav-icon py-2 w-auto">
																<span class="svg-icon svg-icon-3x">
											...
											<div class="card-body">
												...
												<table  class="table table-bordered table-checkable" id="order-listing">
													...
													@if(Auth::user()->lokasi_kerja == $order->order_lokasilab)
													  @if($order->order_status == "Cetak sertifikat")
														<tr>
															<td>{{$no++}}</td>
															<td width="200px">
                                                            ...
                                                            <td style="text-align:center;"><a href=""  class="btn btn-icon btn-success"><i class="fas fa-print"></i></a></td>
															<td>
																<form action="/sertifikatselesai/{{$order->order_id}}" method="post">
																@csrf
                                                                    <select name="order_status" class="form-control">
                                                                        <option>Pilih Status</option>
                                                                        <option value="Cetak ATE-04">Sertifikat selesai</option>
                                                                    </select>
