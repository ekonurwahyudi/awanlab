				...
				<div class="row">
					...
					<div class="card-header flex-wrap py-5">
						<div class="card-title">
							<h5 class="card-label">Halaman Tambah User</h5>
						</div>
					...
					<div class="card-body">
						<!--begin: Datatable-->
						<form action="/tambah-user/proses" method="POST" enctype="multipart/form-data">
							@csrf
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-6">
										<input class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" type="text"  id="example-text-input"/>
									</div>
									@error('name')
                                ...
                                <div class="form-group row">
									...
									<div class="col-6">
										<input class="form-control @error('no_hp') is-invalid @enderror" name="no_hp" value="{{ old('no_hp') }}" type="text"  id="example-text-input"/>
									</div>
									@error('no_hp')
										<div class="alert alert-danger mt-2">
											{{ $message }}
                                ...
                                <div class="form-group row">
									...
									<div class="col-6">
										<input class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" type="email"  id="example-text-input"/>
									</div>
									@error('email')
										<div class="alert alert-danger mt-2">
											{{ $message }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-6">
                                        <textarea class="form-control @error('alamat') is-invalid @enderror" id="exampleTextarea" name="alamat" rows="4" style="width:450px;">&nbsp;</textarea>
                                    </div>
                                    @error('alamat')
                                        <div class="alert alert-danger mt-2">
                                            {{ $message }}
