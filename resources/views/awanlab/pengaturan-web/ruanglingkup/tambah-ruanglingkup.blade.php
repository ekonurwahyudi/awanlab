										...
										<form action="/pengaturan/ruanglingkup-proses" method="POST">
											...
											<div class="card-body">
												...
												<div class="form-group row">
													...
													<div class="col-8">
                                                        <select class="custom-select form-control" name="ruanglingkup_lokasi" value="{{ old('ruanglingkup_lokasi')}}">
                                                            <option selected>Pilih Lokasi Lab</option>
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-8">
                                                        <select class="custom-select form-control" name="ruanglingkup_kelompokukur" value="{{ old('ruanglingkup_kelompokukur')}}">
                                                            <option selected>Pilih Kelompok pengukuran</option>
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-8">
														<input class="form-control" name="ruanglingkup_instrument"  type="text" value="{{old('ruanglingkup_instrument')}}" id="example-text-input"/>
													</div>
												...
												<div class="form-group row">
													...
													<div class="col-6">
                                                        <textarea class="form-control" id="exampleTextarea" name="ruanglingkup_frekuensi" rows="7">&nbsp;</textarea>
													</div>
												</div>
                                                <div class="form-group row">
													<label  class="col-2 col-form-label">Rentang Ukur</label>
													<div class="col-6">
                                                        <textarea class="form-control" id="exampleTextarea" name="ruanglingkup_rentangukur" rows="7"></textarea>
													</div>
												</div>
                                                <div class="form-group row">
													<label  class="col-2 col-form-label">Ketidakpastian</label>
													<div class="col-6">
                                                        <textarea class="form-control" id="exampleTextarea" name="ruanglingkup_ketidakpastian" rows="7"></textarea>
													</div>
												</div>
