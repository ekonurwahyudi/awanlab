                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <div class="page-title-heading">
                                <h2 class="title">{{$artikels->artikel_judul}}</h2>
                            </div>
                        ...
                        <article class="post ttm-blog-single clearfix">
                            ...
                            <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
                                <div class="ttm-post-featured">
                                    <img class="img-fluid" src="{{ url('storage/artikels/'.$artikels->artikel_gambar)}}" width="740px" alt="">
                                </div>
                            ...
                            <div class="ttm-blog-single-content">
                                <div class="ttm-post-entry-header">
                                    <div class="post-meta">
                                        <span class="ttm-meta-line byline"><i class="fa fa-user"></i>{{$artikels->artikel_editor}}</span>
                                        <span class="ttm-meta-line entry-date"><i class="fa fa-calendar"></i><time class="entry-date published" datetime="2018-07-28T00:39:29+00:00">{{$artikels->artikel_date}}</time></span>
                                    </div>
                                </div>
                                <div class="entry-content">
                                    <div class="ttm-box-desc-text">
                                        <p>{{Strip_tags($artikels->artikel_deskripsi)}}</p>
                    ...
                    <div class="col-lg-4 widget-area sidebar-right">
                        <aside class="widget widget-search">
                            <form role="search" method="get" class="search-form" action="#">
                                <label>
                                    ...
                                    <input type="search" class="input-text" placeholder="Cari Artikel...." value="" name="s">
                                </label>
                        ...
                        <aside class="widget widget-recent-post with-title">
                            ...
                            <ul class="widget-post ttm-recent-post-list">
                                ...
                                <li>
                                    <a href="/artikel/{{$post->artikel_id}}"><img class="img-fluid" src="{{ url('storage/artikels/'.$post->artikel_gambar)}}" alt="post-img"></a>
                                    <span class="post-date">{{$post->artikel_date}}</span>
                                    <a href="/artikel/{{$post->artikel_id}}">{{$post->artikel_judul}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </aside>
