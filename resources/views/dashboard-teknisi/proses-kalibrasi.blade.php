										...
										<div class="card card-custom gutter-b card-stretch card-shadowless">
											...
											<div class="card-body p-0">
												...
												<ul class="dashboard-tabs nav nav-pills nav-danger row row-paddingless m-0 p-0 flex-column flex-sm-row" role="tablist">
													...
													<!--begin::Item-->
													<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
														<a class="nav-link active border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" href="/proses-kalibrasi">
															<span class="nav-icon py-2 w-auto">
																<span class="svg-icon svg-icon-3x">
													...
													<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-0 mb-3 mb-lg-0">
														<a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center"  href="/riwayat-kalibrasi">
															<span class="nav-icon py-2 w-auto">
																<span class="svg-icon svg-icon-3x">
											...
											<div class="card-body">
												...
												<table  class="table table-bordered table-checkable" id="order-listing">
													...
													@if(Auth::user()->lokasi_kerja == $order->order_lokasilab)
													  @if($order->order_status == "Sedang dikalibrasi")
														...
														<tr>
                                                            ...
                                                            <td><button class="btn btn-success btn-sm">Mulai Perhitungan</button></td>
															<td>
																<form action="/cetaksertifikat/{{$order->order_id}}" method="post">
																@csrf
